import { buildBillingHeaderValue, getCliVersion, getEntrypoint, } from "./signing.js";
 ...
 */
export function injectBillingHeader(payload) {
    ...
    if (!Array.isArray(p.messages))
        return undefined;
    const system = Array.isArray(p.system)
        ? p.system
        : [];
